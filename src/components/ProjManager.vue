  ...
  <el-container direction="vertical">
    ...
    <el-main class="up-main">
      <el-table
        ...
        <el-table-column prop="projId" label="项目编号" sortable width="120"></el-table-column>
      ...
      <el-dialog width="40%" title="请正确填写表单" :visible.sync="dialogFormVisible">
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="计划工期">
            <el-input clearable v-model="form.projPlanDur" placeholder="已有计划时间时无效"></el-input>
          </el-form-item>
          <el-row>
            <el-col :span="12">
              <div class="grid-content bg-purple">
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple-light">
                <el-form-item label="当前状态">
                  <el-select v-model="form.projState" clearable filterable placeholder="请选择">
                    <el-option
